  ...
  return (
    <View className="w-full self-stretch items-center">
      ...
      <View className="bg-black/20 self-stretch items-center pb-6 border border-white/10 mx-3 rounded-2xl -mt-5">
        ...
        <Text className="font-bold text-2xl text-zinc-50 mt-4">Juan Severiano</Text>
        <Text className="font-regular text-base text-zinc-300 mb-4">juansev@gmail.com</Text>
